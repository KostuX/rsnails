...
export const Email = ({ size = 32, width, height, ...props }) => {
  return <TfiEmail size={size} />;
};

export const Phone = ({ size = 32, width, height, ...props }) => {
  return <LuPhoneCall size={size} />;
};

export const Location = ({ size = 32, width, height, ...props }) => {
